...
class MOT:
    def __init__(self, size,
        ...
        if self.detector_type == DetectorType.SSD:
            ...
            self.detector = YOLODetector(self.size, modelpath, self.class_ids, **vars(yolo_detector_cfg))
        ...
        self.extractors = [FeatureExtractor(modelpath,**vars(cfg)) for cfg in feature_extractor_cfgs]
