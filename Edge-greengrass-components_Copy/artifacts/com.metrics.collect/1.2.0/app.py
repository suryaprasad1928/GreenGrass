...
def terminateProcess(signalNumber, frame):
    ...
    raise RuntimeError("The process is requested to be terminated. finally block will handle the cleanup")
...
def main():
    ...
    while True:
        try:
            ...
            logger.info("opened the camera video. Moving to processing..")
            break
                ...
                if (args.sendmqtt or args.streamtos3) and mot.frame_count % send_by_frame == 0:
                    ...
                    if args.streamtos3:
                        ...
                        if tmp_tlbrs is not None:
                            ...
                            try:
                                streamtos3.send_frame_to_disk(orig_frame,now,current_timestamp,mot.frame_count)
                                streamtos3.send_tracks_to_disk(tmp_imgs,tmp_trkids,tmp_tlbrs,now,current_timestamp,mot.frame_count)
